{
  inputs = {
    ...
    #nixpkgs-small.url = "github:NixOS/nixpkgs/nixpkgs-unstable";
    #nixpkgs-small.url = "github:NixOS/nixpkgs/6cdc7fc76e8bf7fde9fa43a849fcaaa70e230dee"; # a commit from nixpkgs-unstable
    ...
    #nixpkgs-pin2.url = "https://releases.nixos.org/nixos/unstable/nixos-26.11pre1040357.e2587caef70c/nixexprs.tar.xz"; # a commit from nixos-unstable
    ...
    */
    ...
    /*
      chaotic-ff-nightly = {
        #url = "github:lonerOrz/nyx-loner";
        url = "github:chaotic-cx/nyx/01550f84c0af977a55bb4b14623de93a4be8fe0f";
        #inputs.nixpkgs.follows = "nixpkgs";
        inputs.home-manager.follows = "home-manager";
      };
    */
    ...
    */
    ...
    claude-desktop = {
      ...
      url = "github:aaddrick/claude-desktop-debian/2d6af53b7dfd0c40b1df004f76dbb36a456c7c83";
      inputs.nixpkgs.follows = "nixpkgs";
      inputs.flake-parts.follows = "flake-parts";
    };
    nix-bwrapper = {
    ...
    */
    ...
    mio-betterbird.url = "github:mio-19/nurpkgs/2c6947547d79905c3bc347e85af92e26ff378fb5";
        ...
        let
          nixpkgs-drv = pkgs.applyPatches {
            ...
            patches = with pkgs; [
              ...
              */
              (fetchpatch {
                name = "rpcs3: fix build with FFmpeg 9";
                url = "https://github.com/NixOS/nixpkgs/pull/552299.diff";
                hash = "sha256-sYHV08NmZ1pqL7CfJRrVKPwVx3PZ2X7G4NxvRXeY7Ps=";
              })
              (fetchpatch {
