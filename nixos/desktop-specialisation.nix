...
with _include;
{
  ...
  specialisation.kde = lib.mkIf (!kdeDMEnabled) {
    configuration = {
      ...
      services.displayManager.plasma-login-manager.enable = lib.mkForce config.plasma-login-manager_instead; # currently default to plasma-x11 see https://github.com/NixOS/nixpkgs/pull/479797#issuecomment-3828791470 https://github.com/NixOS/nixpkgs/pull/479797#issuecomment-3789819294
