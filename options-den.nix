# Den aspect entrypoint: shared options (den.aspects.options) for NixOS and nix-darwin.
...
{
  imports = [
    (denConfig.config.den.lib.aspects.resolve class denConfig.config.den.aspects.options)
  ];
}
