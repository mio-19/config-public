...
// rec {
  ...
  program = rec {
    ...
    pnpm = pkgs.pnpm_9.override { nodejs-slim = nodejs; };
    pnpm_9 = pkgs.pnpm_9.override { nodejs-slim = nodejs; };
    ppnpm_10 = pkgs.pnpm_10.override { nodejs-slim = nodejs; };
