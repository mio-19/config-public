{
  ...
  inputs = {
    ...
    nixpkgs-pin5.url = "https://releases.nixos.org/nixpkgs/nixpkgs-26.11pre1071116.aff8a0b28396/nixexprs.tar.zst"; # a commit from nixpkgs-unstable
    ...
    */
    ...
    darwin-emacs = {
      ...
      url = "github:nix-giant/nix-darwin-emacs/3c34cf8436db711ae4048245022d1ac6fa6c0622";
      inputs.nixpkgs.follows = "nixpkgs";
